    ...
    while True:
        try:
            ...
            if salariobruto < 1100:
                print('\033[0:31mERRO! Valor de salário inválido e menor que o permitido tente novamente\033[m')
            else:
                salarioliquido = 0
                inss = 0
                irrf = 0
                ...
                while True:
                    try:
                        ...
                        if dependente < 0:
                            print('\033[0:33mERRO! Valor de dependentes inválido tente novamente\033[m')
                        else:
                            if salariobruto <= 1903.98:
                                print('\033[0:36mIsento para contribuição do imposto de renda.\033[m')
                        ...
                        print('\033[0:31mERRO! Tente novamente Digitando apenas valores numéricos inteiros.\033[m')
                ...
                while True:
                    try:
                        ...
                        if planosaude == 'S' or planosaude == 's':
                            ...
                            if valorsaude < 0:
                                print('\033[0:31mERRO! Valor inválido tente novamente\033[m')
                            else:
                            ...
                            print('\033[0:31mERRO! Tente novamente Digitando apenas S ou N\033[m')
                    except ValueError:
                        print('\033[0:31mERRO! Valor inválido tente novamente\033[m')
                        ...
                        if ferias == 'S' or ferias == 's':
                            ...
                            if diasferias < 0 or diasferias > 30:
                                ...
                                if feriasliq <= 1903.98:
                                    print('\033[0:36mIsento para contribuição do imposto de renda no valor das férias.\033[m')
                ...
                while True:
                    try:
                        ...
                        if bonus == 'S' or bonus == 's':
                            ...
                            if valorbonus < 0:
                                print('\033[0:31mERRO! Valor de inválido tente novamente\033[m')
                            else:
                ...
                while True:
                    try:
                        ...
                        if aceitacriptografia == 'S' or aceitacriptografia == 's':
                            ...
                            if vendferias == 'S' or vendferias == 's':
                                print(f'|    |Valor férias vendidas |    \033[0:32mR${valorferias:.2f}\033[m\n{"-" * 46}')
                                break
                            ...
                            if salariobruto > 6433.57:
                                print(
                                    f'|    |INSS                   |R$\033[0:31m{inss:^17.2f}\033[m|{aliqinss:.2f}\033[m       ')
                            else:
                                print(
                                    f'|    |INSS                   |R$\033[0:31m{inss:^17.2f}\033[m|{aliqinss:.2f}%\033[m       ')
                            print(
            ...
            print('\033[0:31m*** ERRO! Tente novamente Digitando apenas valores numéricos.*** \033[m')
main()